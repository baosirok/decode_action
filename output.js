//Sat Feb 01 2025 09:55:33 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
import { nanoid } from "./nanoid.js";
import { service } from "./http/service.min.js";
let dev_baseUrl = "https://duse-ajax.liak.life";
let baseUrl = window.whatTMDwhatTMDApiDomain || dev_baseUrl;
const USER_INFO_KEY = "u-i";
const USER_HISTORY_KEY = "u-h";
const DEVICE_ID_KEY = "d-i";
const DEVICE_CREATEDAT_KEY = "d-c-a";
const CHANNEL_ID = "c-i";
let geturl = window.location.href;
const getqyinfo = geturl.split("?")[1];
let getqys = new URLSearchParams("?" + getqyinfo);
let getqyc = getqys.get("_c");
...
KKYS.userUtils = {
  ...
  formatTimestamp: _0x190d76 => {
    ...
    const _0x1a5f9d = _0x9d1d78.getFullYear();
    const _0x25e823 = _0x9d1d78.getMonth() + 1;
    const _0x5f1bf4 = _0x9d1d78.getDate();
    const _0x230ac4 = _0x1a5f9d + "-" + (_0x25e823 < 10 ? "0" + _0x25e823 : _0x25e823) + "-" + (_0x5f1bf4 < 10 ? "0" + _0x5f1bf4 : _0x5f1bf4) + " " + _0x9d1d78.toTimeString().substring(0, 8);
    return _0x230ac4;
  },
  getQueryVariable: _0x1f9335 => {
    var _0x35cd15 = window.location.search.substring(1);
    var _0x513320 = _0x35cd15.split("&");
  ...
  addReadHistory: _0x32da76 => {
    var _0x2b6bdc = [];
    var _0x544c2c = localStorage.getItem(USER_HISTORY_KEY);
  ...
  getTopLevelDomain: () => {
    ...
    const _0x4f4b56 = _0x1ce630.split(".");
    const _0x5d58c6 = _0x4f4b56.slice(-2).join(".");
    const _0x312be7 = ["co.uk", "co.jp", "ac.jp", "co.in", "com.au", "com.cn", "gov.au"];
  ...
  sign: (_0x4d9484, _0x5744e4, _0xbbda50, _0x1f7db1) => {
    ...
    const _0x2def83 = _0x4d9484 + "|" + _0x5744e4 + "|" + _0xbbda50 + "|" + _0x1f7db1 + "|" + _0x390ccb + "|";
    const _0x530d5d = CryptoJS.HmacSHA1(_0x2def83, KKYS.Settings.HASH).toString(CryptoJS.enc.Hex);
    return _0x530d5d;
  },
  ...
  apiDecrypt: (_0x4b5edb, _0x1d9b1e, _0x26a57f) => {
    ...
    let _0x478e3 = CryptoJS.enc.Utf8.parse(_0x26a57f);
    _0x4b5edb = (_0x4b5edb + "").replace(/\n*$/g, "").replace(/\n/g, "");
    const _0x115654 = CryptoJS.enc.Base64.parse(_0x4b5edb);
    const _0x5cc3b8 = CryptoJS.enc.Base64.stringify(_0x115654);
    const _0x112f08 = CryptoJS.AES.decrypt(_0x5cc3b8, _0x5b2b67, {
      iv: _0x478e3,
    ...
    encrypt: function (_0x2a720f, _0xf76075 = _0x20fa80, _0x270bce = _0x50ac65) {
      ...
      if (typeof _0x2a720f == "string") {
        ...
        if (typeof _0x2a720f == "object") {
          ...
          const _0x7c5e8 = CryptoJS.enc.Utf8.parse(_0xa425cf);
    ...
    decrypt: function (_0x4a7572, _0x4ae439 = _0x20fa80, _0x5a8ee0 = _0x50ac65) {
      {
        ...
        const _0x1f4a82 = CryptoJS.enc.Base64.stringify(_0x1249fd);
        const _0x16a79b = CryptoJS.AES.decrypt(_0x1f4a82, _0x4ae439, {
          iv: _0x5a8ee0,
          mode: CryptoJS.mode.CBC,
          padding: CryptoJS.pad.Pkcs7
        });
        const _0x28abc2 = _0x16a79b.toString(CryptoJS.enc.Utf8);
...
KKYS.API = {
  ...
  getAnnouncements: () => {
    const _0x3f9a7f = "get";
    const _0x205557 = "/app/announcements";
    const _0x4fa495 = "";
    const _0x507ec6 = Date.now();
    const _0x9b754d = KKYS.API.generalHttpHeaders();
  ...
  getAdvertises: () => {
    const _0x296709 = "get";
    const _0x451149 = "/config/units";
    const _0x294ec6 = "";
    const _0x34f13d = Date.now();
    const _0x4581ca = KKYS.API.generalHttpHeaders();
  ...
  regist: _0x15ec1d => {
    ...
    const _0x5bbee5 = "";
    const _0x4114ba = Date.now();
    const _0x10f17f = KKYS.API.generalHttpHeaders();
  ...
  login: _0x443dbb => {
    ...
    const _0x3aa27f = "/user/login";
    const _0x28fd18 = "";
    const _0x429fb7 = Date.now();
    const _0x477ea6 = KKYS.API.generalHttpHeaders();
  ...
  updatePassword: _0x4f1d13 => {
    ...
    const _0x2dbda3 = "/user/changeAccountPassword";
    const _0x8d2e73 = "";
    const _0x279cc3 = Date.now();
    const _0x1b6cc3 = KKYS.API.generalHttpHeaders();
  ...
  feedback: _0x1952bc => {
    ...
    const _0x330933 = "";
    const _0x201037 = Date.now();
    const _0x6b9ce = KKYS.API.generalHttpHeaders();
  ...
  getUserInfo: () => {
    const _0xb11729 = "get";
    const _0x5ac4f2 = "/user/info";
    const _0x95d8e6 = "";
    const _0x563414 = Date.now();
    const _0x56657c = KKYS.API.generalHttpHeaders();
  ...
  getHistories: () => {
    const _0x455f9f = "get";
    const _0x1ea6d5 = "/vod/histories";
    const _0x39372f = "";
    const _0xe5c700 = Date.now();
    const _0x131479 = KKYS.API.generalHttpHeaders();
  ...
  clearHistories: _0x59dd43 => {
    ...
    const _0x10d8e6 = "";
    const _0x245b44 = Date.now();
    const _0x1a26a7 = KKYS.API.generalHttpHeaders();
  ...
  getVodState: _0x4f752d => {
    const _0x15ebc3 = "get";
    const _0x3afb79 = "/vod/vodState";
    const _0xfd76ad = "";
    const _0x5122fe = Date.now();
  ...
  getFavories: () => {
    const _0x2caa9b = "get";
    const _0x383ec1 = "/vod/library";
    const _0x2caab3 = "";
    const _0x17603b = Date.now();
    const _0x159b53 = KKYS.API.generalHttpHeaders();
  ...
  addFavorite: _0x33fb27 => {
    ...
    const _0x53d96e = "/vod/favor";
    const _0x371079 = "";
    const _0xcdfc23 = Date.now();
    const _0x1f1201 = KKYS.API.generalHttpHeaders();
  ...
  removeFavorite: _0x16fbbe => {
    ...
    const _0x3ea9a4 = "/vod/batchUnFavor";
    const _0x1e65ca = "";
    const _0x427ff7 = Date.now();
    const _0x1488f9 = KKYS.API.generalHttpHeaders();
  ...
  shareVod: _0x4a4045 => {
    ...
    const _0x34c8d2 = "/vod/share";
    const _0xaa415f = "";
    const _0xe9ef0e = Date.now();
    const _0x4a2cb3 = KKYS.API.generalHttpHeaders();
  ...
  sendVodPlayLog: _0x4e801b => {
    ...
    const _0x30da3a = "get";
    const _0x2ada76 = "/vod/playOnlineLog";
    const _0x5094df = "";
  ...
  sendVodLoadLog: _0x5130e7 => {
    ...
    const _0x182275 = "get";
    const _0x18dc74 = "/vod/loadLog";
    const _0x256bdd = "";
    const _0x137c20 = Date.now();
  ...
  sendReport: _0x27e5c5 => {
    ...
    const _0x172021 = "/vod/report";
    const _0x1085e6 = "";
    const _0x42dac8 = Date.now();
    const _0x1a1646 = KKYS.API.generalHttpHeaders();
  ...
  getNetflixIssues: _0x13ca96 => {
    const _0xf64d0a = "get";
    const _0x1b6131 = "/vod/copyrightVods";
    const _0x394074 = "";
    const _0x312e8b = Date.now();
    const _0x83e6da = KKYS.API.generalHttpHeaders();
